...
This planned industry pattern shows OKE, segmented subnets, private connectivity, service exposure, observability, security scanning, and platform operations for telco workloads.
...
```text
Telco Platform Operators
          |
          v
+----------------------+      +----------------------+
| OKE Control Plane    | ---> | Node Pools / CNFs    |
| private endpoint     |      | segmented subnets    |
+----------------------+      +----------------------+
          |                            |
          v                            v
+----------------------+      +----------------------+
| Private Connectivity |      | Service Exposure     |
| DRG, FC, VPN         |      | LB, ingress, API     |
+----------------------+      +----------------------+
          |                            |
          v                            v
+----------------------+      +----------------------+
| Security Scanning    |      | Observability        |
| images, posture      |      | logs, metrics, SIEM  |
+----------------------+      +----------------------+
```
