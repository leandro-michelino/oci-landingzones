...
This planned identity pattern captures administrator and auditor groups, policy scope, identity-domain assumptions, and break-glass access for CIS-aligned environments.
...
|   +-- tenancy admins, security admins, network admins
+-- Auditor Groups
|   +-- read-only audit and evidence access
+-- Break-Glass Access
|   +-- emergency group, monitored and reviewed
|
+-- Policy Bindings
    +-- tenancy-level guardrails
    +-- compartment-scoped administration
