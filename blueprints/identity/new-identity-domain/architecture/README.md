...
- `new-identity-domain.excalidraw`
- `new-identity-domain.png`

The diagram should show the new identity domain, baseline groups, federation options,
break-glass access, and policy scope.
