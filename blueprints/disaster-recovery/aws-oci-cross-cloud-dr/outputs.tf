...
output "standby_target" {
  description = "Declared standby workload target for failover. In this variant AWS is the secondary endpoint activated by DR runbooks."
  value = {
    cloud    = "aws"
    endpoint = var.aws_standby_endpoint
  }
}
