...
variable "connectivity_mode" {
  description = "Cross-cloud connectivity mode between OCI and AWS for DR data/control lanes."
  type        = string
...
variable "direct_connect_connection_id" {
  description = "AWS Direct Connect connection resource ID used when connectivity_mode is interconnect."
  type        = string
  default     = null
}
...
variable "app_fqdn" {
  description = "Application FQDN used for DNS failover between OCI primary and AWS standby."
  type        = string
...
variable "aws_standby_endpoint" {
  description = "AWS standby application endpoint used by DNS failover runbooks."
  type        = string
  default     = null
}
...
variable "aws_standby_health_path" {
  description = "Health-check path used for AWS standby endpoint validation."
  type        = string
  default     = "/healthz"
}
