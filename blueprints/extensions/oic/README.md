...
Use this page as the operator guide for `blueprints/extensions/oic`. It tells you what the blueprint builds, which inputs deserve a real review, how to run Terraform or the local Ansible wrappers, and where to find the detailed Architecture design.
...
| Outputs to hand off | `blueprint_name`, `name_prefix`, `resource_ids`, `integration_instance_id`, `outbound_connection_id` |
