...
resource "terraform_data" "traffic_steering_contract" {
  ...
  lifecycle {
    precondition {
      ...
      error_message = "When enable_oci_traffic_management=true, set oci_traffic_management_zone_id, app_fqdn or oci_traffic_management_domain_name, oci_primary_endpoint, and aws_secondary_endpoint."
    }
  }
}
