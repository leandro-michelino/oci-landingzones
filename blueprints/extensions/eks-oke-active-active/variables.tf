...
variable "eks_cluster_id" {
  description = "Existing EKS cluster resource ID used as the secondary active/active target."
  type        = string
  default     = null
}
...
variable "oci_primary_traffic_percent" {
  description = "Traffic percentage directed to OCI as primary. Remaining traffic goes to EKS secondary."
  type        = number
  default     = 100
