...
This is the deployment architecture for `blueprints/extensions/streaming`. It keeps the design reviewable in GitHub, terminals, pull requests, runbooks, and customer-safe notes without a diagramming tool.
