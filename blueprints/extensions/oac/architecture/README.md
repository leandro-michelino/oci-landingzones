...
This page is the deployment architecture for `blueprints/extensions/oac`. It is intentionally Architecture-first so it is easy to review in GitHub, terminals, pull requests, runbooks, and customer notes without a diagramming tool.
