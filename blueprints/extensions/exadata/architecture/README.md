...
This is the design view for `blueprints/extensions/exadata`. It stays ASCII-first on purpose
...
| Item | Details |
| --- | --- |
| Boundary | `blueprints/extensions/exadata` owns this deployment end to end. |
...
| 01. resource.oci_database_cloud_exadata_infrastructure.this                                          |
|                                                                                                      |
...
For Exadata Extension, the important hand-off values are `blueprint_name`, `name_prefix`,
`resource_ids`, `cloud_exadata_infrastructure_id`. Keep those names stable unless a
