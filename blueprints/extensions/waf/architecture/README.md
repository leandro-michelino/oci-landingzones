...
This is the design view for `blueprints/extensions/waf`. It stays ASCII-first on purpose so
...
| Item | Details |
| --- | --- |
| Boundary | `blueprints/extensions/waf` owns this deployment end to end. |
...
| 01. resource.oci_waf_web_app_firewall_policy.this                                                    |
| 02. resource.oci_waf_web_app_firewall.this                                                           |
|                                                                                                      |
...
For WAF Extension, the important hand-off values are `blueprint_name`, `name_prefix`,
`resource_ids`, `waf_policy_id`, `web_app_firewall_id`. Keep those names stable unless a
