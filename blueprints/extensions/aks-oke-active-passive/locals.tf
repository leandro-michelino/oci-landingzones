...
locals {
  blueprint_name          = "extensions-aks-oke-active-passive"
  ...
  traffic_management_standby_answer  = var.azure_secondary_endpoint
  ...
  dns_failover_contract = {
    ...
    standby_endpoint  = var.azure_secondary_endpoint
