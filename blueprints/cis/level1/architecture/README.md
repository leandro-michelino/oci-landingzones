...
This is the deployment architecture for `blueprints/cis/level1`. It keeps the design reviewable in GitHub, terminals, pull requests, runbooks, and customer-safe notes without a diagramming tool.
