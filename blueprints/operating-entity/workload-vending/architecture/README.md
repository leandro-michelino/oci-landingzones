...
The workload-vending blueprint packages a standard application landing area with compartment, IAM, budget, logging, tags, quota, network attachment, and platform handoff points.
...
```text
Platform Team Request Intake
          | approved workload package
          v
+----------------------+
...
+----------------------+
      ...
      v             v
+-----------+   +----------------------+
| IAM       |   | Network Attachment   |
| app team  |   | hub/spoke or VCN     |
+-----------+   +----------------------+
      |             |
      v             v
Logging, monitoring, handoff notes, and lifecycle owner
```
