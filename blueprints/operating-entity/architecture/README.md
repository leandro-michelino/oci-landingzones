# Operating Entity Architecture

Author: Leandro Michelino | ACE | leandro.michelino@oracle.com

The operating-entity blueprint onboards a business unit or subsidiary with a compartment structure, delegated groups, policies, budgets, logging, network attachment, and optional extensions.
...
```text
OCI Tenancy
+-- Operating Entity Compartment
|   +-- Platform / shared administration
|   +-- Workload parent compartments
|   +-- Budgets, quotas, tags, logging
|
+-- Delegated IAM
|   +-- entity admins, operators, auditors
|   +-- policies scoped to entity boundary
|
+-- Network Attachment
    +-- existing hub/spoke or standalone VCN
    +-- optional extensions attached by workload need
```
