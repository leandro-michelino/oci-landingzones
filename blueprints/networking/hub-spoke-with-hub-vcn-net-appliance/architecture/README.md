...
- `hub-spoke-with-hub-vcn-net-appliance.png`

The diagram should show NVA interfaces, management path, trust/untrust routing, DRG
attachments, spoke VCNs, and failure-domain or HA placement.
