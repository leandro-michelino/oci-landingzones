...
This is the design view for `blueprints/networking/regional-prod-nonprod-hubs`. It stays
...
| Item | Details |
| --- | --- |
| Boundary | `blueprints/networking/regional-prod-nonprod-hubs` owns this deployment end to end. |
...
| 01. module.prod_network -> blueprints/networking/hub-spoke-with-drg-and-three-tier-vcns @ v0.2.0     |
| 02. module.nonprod_network -> blueprints/networking/hub-spoke-with-drg-and-three-tier-vcns @ v0.2.0  |
|                                                                                                      |
...
For Regional Prod Nonprod Hubs, the important hand-off values are `blueprint_name`,
`name_prefix`, `resource_ids`, `prod_hub_vcn_id`, `nonprod_hub_vcn_id`, `prod_drg_id`,
`nonprod_drg_id`. Keep those names stable unless a downstream blueprint, runbook, or
