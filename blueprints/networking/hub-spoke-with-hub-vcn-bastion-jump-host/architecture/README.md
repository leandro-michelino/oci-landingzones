...
This page is the deployment architecture for `blueprints/networking/hub-spoke-with-hub-vcn-bastion-jump-host`. It is intentionally Architecture-first so it
