...
This page is the deployment architecture for `blueprints/networking/hub-spoke-with-drg-and-three-tier-vcns`. It is intentionally Architecture-first so it
