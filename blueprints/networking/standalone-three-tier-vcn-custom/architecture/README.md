...
This is the design view for `blueprints/networking/standalone-three-tier-vcn-custom`. It
...
| Item | Details |
| --- | --- |
| Boundary | `blueprints/networking/standalone-three-tier-vcn-custom` owns this deployment end to end. |
...
For Standalone Three-Tier VCN Custom, the important hand-off values are `blueprint_name`,
`name_prefix`, `resource_ids`, `vcn_id`, `subnet_ids`, `route_table_ids`, `gateway_ids`.
