...
Start here for `blueprints/networking/standalone-three-tier-vcn-custom`: what it builds, which inputs deserve a careful look, how to run Terraform or the local Ansible wrappers, and where the detailed architecture notes live.

## At A Glance

| Item | Details |
| --- | --- |
| Folder | `blueprints/networking/standalone-three-tier-vcn-custom` |
| Best fit | Creates a standalone three-tier workload VCN with custom CIDRs, subnets, route tables, gateways, and security lists. |
| Terraform shape | `workload_vcn` |
| Inputs to settle first | `compartment_ocid`, `vcn_label`, `vcn_dns_label`, `vcn_cidr_blocks`, `subnets`, `route_tables`, `security_lists` |
...
Creates a standalone three-tier workload VCN with custom CIDRs, subnets, route tables,
gateways, and security lists.
...
| Input | What To Decide |
| --- | --- |
| `compartment_ocid` | Compartment OCID where the standalone VCN is available. Defaults to tenancy_ocid for simple tests. |
| `vcn_label` | Short label for the workload VCN. |
| `vcn_dns_label` | DNS label for the workload VCN. |
| `vcn_cidr_blocks` | CIDR blocks for the workload VCN. |
| `subnets` | Custom subnet map. |
| `route_tables` | Custom route tables keyed by logical name. |
| `security_lists` | Custom security lists keyed by logical name. |

### Enable Flags And Switches

| Input | What To Decide |
| --- | --- |
| `enable_internet_gateway` | Create an internet gateway. |
| `enable_nat_gateway` | Create a NAT gateway. |
| `enable_service_gateway` | Create a service gateway. |
