...
This page is the deployment architecture for `blueprints/networking/hub-spoke-with-multicloud-interconnect`. It is intentionally Architecture-first so it
