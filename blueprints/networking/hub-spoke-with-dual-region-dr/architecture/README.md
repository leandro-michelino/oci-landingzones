...
- `hub-spoke-with-dual-region-dr.excalidraw`
- `hub-spoke-with-dual-region-dr.png`

The diagram should show both regions, remote peering, primary/secondary hubs, spokes,
routing, DNS behavior, and failover paths.
