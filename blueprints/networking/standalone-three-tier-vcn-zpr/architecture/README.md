...
- `standalone-three-tier-vcn-zpr.excalidraw`
- `standalone-three-tier-vcn-zpr.png`

The diagram should show VCN tiers, ZPR attributes, allowed flows, denied flows,
gateways, and operational access paths.
