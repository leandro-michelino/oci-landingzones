# Standalone Private Endpoint Architecture

Author: Leandro Michelino | ACE | leandro.michelino@oracle.com

This standalone pattern creates private subnets and private service access only, with service gateway, optional NAT, DNS, and administrative paths documented up front.
...
+----------------------+
      ...
      v             v
+-----------+   +----------------------+
| SGW       |   | Private Endpoints    |
| OCI APIs  |   | DB, analytics, apps  |
+-----------+   +----------------------+
      |             |
      v             v
Optional NAT      Private DNS resolution
```
