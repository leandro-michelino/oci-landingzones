...
This page is the deployment architecture for `blueprints/networking/hub-spoke-with-private-dns-split-horizon`. It is intentionally Architecture-first so it
