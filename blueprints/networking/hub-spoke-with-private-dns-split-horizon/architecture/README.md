...
This pattern centralizes private DNS zones, resolvers, forwarding rules, query direction, spoke VCN associations, and optional on-premises DNS dependencies.
...
+----------------------+
          ...
          v
+----------------------+      +----------------------+
| Hub Private DNS      | ---> | Private Zones        |
| resolver endpoints   |      | internal names       |
+----------------------+      +----------------------+
          |
          v
+----------------------+
| On-prem DNS optional |
| conditional forward  |
+----------------------+
```
