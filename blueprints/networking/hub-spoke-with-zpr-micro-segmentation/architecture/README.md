...
This pattern applies ZPR attributes and policies to hub-spoke application boundaries so allowed, denied, and inspected flows are visible before deployment.
...
+----------------------+
      ...
      v
+----------------------+      +----------------------+
| Hub / Inspection     | ---> | Spoke App Boundary   |
| optional path        |      | web, app, db         |
+----------------------+      +----------------------+
      | denied policy              |
      +----------------------------+
        denied flows remain outside segment rules
```
