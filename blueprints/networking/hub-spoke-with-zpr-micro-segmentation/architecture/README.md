...
- `hub-spoke-with-zpr-micro-segmentation.excalidraw`
- `hub-spoke-with-zpr-micro-segmentation.png`

The diagram should show ZPR attributes, application boundaries, hub/spoke VCNs, allowed
flows, denied flows, and inspection paths if used.
