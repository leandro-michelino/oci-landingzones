...
Start here for `blueprints/networking/hub-spoke-with-hub-vcn-ipsec-vpn`: what it builds, which inputs deserve a careful look, how to run Terraform or the local Ansible wrappers, and where the detailed architecture notes live.
