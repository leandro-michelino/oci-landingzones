...
This is the deployment architecture for `blueprints/networking/hub-spoke-with-hub-vcn-net-firewall`. It keeps the design reviewable in GitHub, terminals, pull requests, runbooks, and customer-safe notes without a diagramming tool.
