...
This is the expected close-out shape for `blueprints/networking/hub-spoke-with-hub-vcn-net-firewall`. Terraform owns the OCI resource graph and
...
network_firewall_private_ip = "<value>"
```
