# Hub-Spoke Network Firewall Architecture

Author: Leandro Michelino | ACE | leandro.michelino@oracle.com

This pattern uses OCI Network Firewall in the hub to inspect internet, private, and spoke traffic through explicit route-table and policy boundaries.
...
+-------------------------+
              ...
              v
+-------------------------+      +-------------------------+
| Firewall Subnet         | ---> | Firewall Policy         |
| OCI Network Firewall    |      | rules, lists, logging   |
+-------------------------+      +-------------------------+
              |
              v
+-------------------------+
