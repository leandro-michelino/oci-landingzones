...
- `hub-spoke-with-hub-vcn-net-firewall.excalidraw`
- `hub-spoke-with-hub-vcn-net-firewall.png`

The diagram should show firewall subnet, firewall policy boundary, DRG route tables,
spoke attachments, internet/private paths, and inspected flows.
