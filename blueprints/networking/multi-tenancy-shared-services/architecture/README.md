...
This is the design view for `blueprints/networking/multi-tenancy-shared-services`. It stays
...
| Item | Details |
| --- | --- |
| Boundary | `blueprints/networking/multi-tenancy-shared-services` owns this deployment end to end. |
...
| 02. module.shared_dns -> modules/networking/dns @ v0.1.0                                             |
|                                                                                                      |
...
For Multi Tenancy Shared Services Network, the important hand-off values are
`blueprint_name`, `name_prefix`, `resource_ids`, `hub_vcn_id`, `spoke_vcn_ids`,
`private_view_id`, `private_zone_ids`. Keep those names stable unless a downstream
