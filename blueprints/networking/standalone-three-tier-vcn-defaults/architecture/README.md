...
This is the design view for `blueprints/networking/standalone-three-tier-vcn-defaults`. It
...
| Item | Details |
| --- | --- |
| Boundary | `blueprints/networking/standalone-three-tier-vcn-defaults` owns this deployment end to end. |
...
For Standalone Three-Tier VCN Defaults, the important hand-off values are `blueprint_name`,
