...
|---|---|---|---|---|---|---|
| 1.1 | Avoid root compartment usage | `iam/compartments` | `core` | Level 1, Level 2 | P0 | Available |
...
| 3.1 | Audit log retention configured | `governance/logging` | `core` | Level 1, Level 2 | P0 | Available |
...
| 3.14 | Cloud Guard enabled | `security/cloud-guard` | `core` | Level 1, Level 2 | P0 | Available |
| 3.17 | Vault with customer-managed keys | `security/vault` | `core` | Level 1, Level 2 | P1 | Available |
...
| 5.1 | Host scanning enabled | `security/vss` | `core` | Level 1, Level 2 | P1 | Available |
| 5.2 | Container image scanning enabled | `security/vss` | `extensions/oke` | Level 1, Level 2 | P2 | Available |
...
they can be marked fully available.
