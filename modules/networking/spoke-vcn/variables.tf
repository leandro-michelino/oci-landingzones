...
variable "enable_internet_gateway" {
  description = "Create an internet gateway for public workload subnets."
  type        = bool
  default     = true
}
...
variable "security_lists" {
  ...
  default = {
    baseline = {
      ingress_rules = [
        {
          description = "Allow HTTP to public web tier by default."
          protocol    = "6"
          source      = "0.0.0.0/0"
          tcp_options = { min = 80, max = 80 }
        },
        {
          description = "Allow HTTPS to public web tier by default."
          protocol    = "6"
          source      = "0.0.0.0/0"
